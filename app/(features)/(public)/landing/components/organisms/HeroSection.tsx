...
const HeroSection = ({ stats, isLoading }: HeroSectionProps) => {
    ...
    <section className="max-w-3xl mx-auto p-4 relative z-10">
      <div className="flex flex-col items-center justify-center pt-6 pb-12">
        ...
        >
          ...
          {isLoading ? (
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 pt-4 w-full">
              {Array.from({ length: 4 }).map((_, i) => (
                <div key={i} className="flex flex-col items-center gap-3">
                  <Skeleton className="size-14 rounded-lg bg-white/10" />
