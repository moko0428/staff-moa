...
export const profiles = pgTable('profiles', {
  ...
  manager_type: text('manager_type'),
  address: text('address'),
  website: text('website'),
  founded_year: text('founded_year'),
  specialties: jsonb('specialties').default(sql`'[]'::jsonb`).$type<string[]>(),
  activity_regions: jsonb('activity_regions').default(sql`'[]'::jsonb`).$type<string[]>(),
