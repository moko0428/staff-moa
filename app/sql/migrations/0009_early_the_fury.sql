...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "app_reviews" ADD CONSTRAINT "app_reviews_user_id_profiles_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("user_id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
